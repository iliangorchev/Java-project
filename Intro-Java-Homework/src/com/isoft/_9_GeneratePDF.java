...
public class _9_GeneratePDF {
	...
	// TODO Generate a PDF by External Library
	// Write a program to generate a PDF document called Deck-of-Cards.pdf and
	// print in it a standard deck of 52 cards, following one after another.
	...
	public static void main(String[] args) throws DocumentException, IOException {
		...
		document.open();
		BaseFont base = BaseFont.createFont("lib/arial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
